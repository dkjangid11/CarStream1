...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Task {
            ...
            if CarStreamAccess.shared.ShowCarStreamSettings == false  {
                ...
                let hostingController = UIHostingController(rootView: CarStreamVideoMainScreen())
    ...
    //        auth.APNSObject.RequestAPNS()
            ...
            CarStreamVideoAPI.shared.deleteOldFiles(from: tempDirectory, olderThan: 4)
            
//            CarStreamLocationAPI.shared.requestLocationPermission()
            DispatchQueue.global(qos: .background).async {
//                CarStreamLocationAPI.shared.startUpdatingLocation()
            }
            ...
            hostingController.didMove(toParent: self)
            await CarStreamVideoAPI.shared.DeviceBooted(VC: self)
        }
