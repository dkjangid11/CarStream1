...
struct AppSettingsView: View {
    @StateObject private var airPlayReceiver = CarStreamAirPlayReceiverManager.shared
    @StateObject private var selfAirPlay = CarStreamSelfAirPlayManager.shared
        ...
        NavigationStack {
            Form {
                Section("AirPlay Receiver") {
                    ...
                    LabeledContent("Receiver name", value: "CarStream Carplay")
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Slider(
                            ...
                            in: CarStreamAirPlayReceiverManager.carPlayViewScaleRange,
                            step: 0.05
                        )
                    }
    ...
    private func startLiveControls() {
        ...
        do {
            try CarStreamControlsLiveActivityManager.start()
        } catch {
    ...
    private func stopLiveControls() {
        ...
        Task {
            await CarStreamControlsLiveActivityManager.stopAll()
        }
    }
