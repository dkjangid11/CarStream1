        ...
        VStack(spacing: 20) {
            ...
            if let videoURL = selectedVideoURL {
                ...
                Button("Send to car") {
                    ...
                    data.URL = videoURL
                    CarStreamVideoShared.shared.CarPlayComp?(data)
                }
                .padding(.top)
            }
...
//                            CarStreamVideoShared.shared.VideoPlayer = AVPlayer(url: url)
//                            isPlaying = false
//                        }
//                        .padding(.horizontal)
            ...
            .fileImporter(
                ...
                do {
                    ...
                    CarStreamVideoShared.shared.VideoPlayer = AVPlayer(url: uniqueURL)
                    isPlaying = false
