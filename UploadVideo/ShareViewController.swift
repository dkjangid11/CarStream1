...
class ShareViewController: SLComposeServiceViewController {
    ...
    private func saveURL(url: URL) {
        let sharedDefaults = UserDefaults(suiteName: "group.net.thomasdye.CarStream-docs")
        sharedDefaults?.set(url.absoluteString, forKey: "TDVideo-SharedURL")

        // Post cross-process notification
               let notificationName = "group.net.thomasdye.CarStream-docs.TDVideo-SharedURL"
    ...
    private func saveVideo(url: URL) {
        ...
        guard let containerURL = fileManager.containerURL(forSecurityApplicationGroupIdentifier: "group.net.thomasdye.CarStream-docs") else {
            saveURL(url: url)
            return
        }
