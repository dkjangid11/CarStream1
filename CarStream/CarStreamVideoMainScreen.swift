//
//  CarStreamVideoMainScreen.swift
//  CarStream
//
...
struct CarStreamVideoMainScreen: View {
...
""")
            ...
            .navigationBarTitle("CarStream", displayMode: .inline)
            .toolbar {
            ...
            .alert("Enter Connection Code", isPresented: $showingCodeAlert, actions: {
                ...
                Button("OK") {
                    if connectionCode.lowercased() == "carplay" {
                        ...
                        CarStreamAccess.shared.ShowCarStreamSettings = true
