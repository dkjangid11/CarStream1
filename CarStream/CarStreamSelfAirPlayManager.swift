...
private let selfAirPlayLogger = Logger(
    subsystem: Bundle.main.bundleIdentifier ?? "net.thomasdye.CarStream-Video2",
...
@MainActor
final class CarStreamSelfAirPlayManager: ObservableObject {
    static let shared = CarStreamSelfAirPlayManager()
    ...
    enum State: Equatable {
        ...
        var description: String {
            ...
            case .connected:
                return "Ready. Open Control Centre, tap Screen Mirroring, and choose CarStream Carplay (This iPhone)."
    ...
    private func enable() async {
        ...
        let receiver = CarStreamAirPlayReceiverManager.shared
    ...
    private func configuredManager(
        ...
        let bundleIdentifier = Bundle.main.bundleIdentifier ?? "net.thomasdye.CarStream-Video2"
        ...
        manager.localizedDescription = "CarStream Self AirPlay"
...
private final class TDSSelfAirPlayServiceResolver: NSObject,
    ...
    func netServiceBrowser(
        ...
        let isAirPlay = service.type.hasPrefix("_airplay") && service.name == "CarStream Carplay"
        let isRAOP = service.type.hasPrefix("_raop") && service.name.hasSuffix("@CarStream Carplay")
