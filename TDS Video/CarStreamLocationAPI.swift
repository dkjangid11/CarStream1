...
import CoreLocation
import SwiftUI
class CarStreamLocationAPI: NSObject, CLLocationManagerDelegate,ObservableObject {
    static let shared = CarStreamLocationAPI()
...
//        if CarStreamAccess.shared.DisableIsStationary == true {
//            isStationary = true
//        }
//    }
//
