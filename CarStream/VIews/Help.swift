...
2. Start screen recording using the app extension:
   ...
   - Select **CarStream** from the dropdown.
3. This screen recording will begin streaming.
4. Open the client app to view the stream.
""")

                    Text("❗️ If the CarStream extension doesn't appear, the system may not have updated the list of available apps. Try waiting a few moments or restarting your device.")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
