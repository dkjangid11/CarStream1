...
@MainActor
final class CarStreamAirPlayReceiverManager: ObservableObject {
    static let shared = CarStreamAirPlayReceiverManager()

    @Published private(set) var isEnabled = false
    @Published private(set) var errorMessage: String?
    @Published private(set) var carPlayViewScale: Double

    static let carPlayViewScaleKey = "CarStreamAirPlayCarPlayViewScale"
    ...
    private let standbyView = CarStreamAirPlayStandbyView()
    ...
    func setEnabled(_ enabled: Bool) {
        ...
        if enabled {
            do {
                log("Starting AirPlayReceiverView named CarStream Carplay")
...
private final class CarStreamAirPlayStandbyView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let title = UILabel()
        title.text = "AirPlay to CarStream Carplay"
        ...
        instructions.text = "Open Control Centre on your other device, tap Screen Mirroring, then choose CarStream Carplay."
